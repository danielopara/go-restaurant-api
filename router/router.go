...
*/
	...
	{
		orderGroup.GET("/orders", middleware.AuthMiddleware(), middleware.RoleMiddleWare(models.RoleAdmin, models.RoleChef, models.RoleWaiter, models.RoleManager, models.RoleCashier), orderHandler.FindAllOrders)
